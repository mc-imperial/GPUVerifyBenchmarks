...
#ifdef ORIGINAL        
        // AD: looks like this would cause a data race, which might be regarded as benign
        // This is what one would use an atomic for.
        sharedArray[localId * BIN_SIZE + value]++;
#else
        // AD: for purposes of analysis, replace this with an update to a fixed location
        sharedArray[localId * BIN_SIZE]++;
#endif
    }
