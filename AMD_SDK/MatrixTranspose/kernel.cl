//pass
//--local_size=[16,16] --num_groups=[8,8]
...
{
	__requires(blockSize == 16 /*get_local_size(0)*/);
	__requires(width == 16*8   /*get_global_size(0)*/);
	__requires(height == 16*8  /*get_global_size(1)*/);
