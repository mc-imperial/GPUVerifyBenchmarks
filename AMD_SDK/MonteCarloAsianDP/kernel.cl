//pass
//--local_size=[256,1] --num_groups=[1,512] -DKHR_DP_EXTENSION
...
{
    __requires(width == 256*1 /*get_global_size(0)*/);
...
#else
	   	meanPrice1 = sumPrice1 / (double)noOfSum;
		meanPrice2 = sumPrice2 / (double)noOfSum;
		meanDeriv1 = sumDeriv1 / (double)noOfSum;
		meanDeriv2 = sumDeriv2 / (double)noOfSum;
#endif
