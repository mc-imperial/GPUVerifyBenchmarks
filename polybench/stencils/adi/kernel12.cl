...
__kernel void kernel12(__global double *p, __global double *q, __global double *u, int n, int tsteps, long c0)
{
  __requires(n == 1024);
  __requires(tsteps == 512);
    ...
    {
      __requires((((((n) >= (3)) & ((n) <= (2147483647))) & ((tsteps) <= (2147483647))) & ((c0) >= (2))) & (((tsteps) + (1)) >= (c0)));
        ...
        for (long c2 = ((n - 3) % 32) - n - 29; c2 < 0; c2 += 32) {
          ...
          if (n >= t0 + c1 + 2 && t0 + c1 >= 1) {
            ...
            for (long c4 = max(0, -n - c2 + 2); c4 <= 31; c4 += 1)
              u[(t0 + c1) * n + (-c2 - c4)] = ((shared_p[t0][-c4 + 31] * u[(t0 + c1) * n + (-c2 - c4 + 1)]) + q[(t0 + c1) * n + (-c2 - c4)]);
          }
          barrier(CLK_LOCAL_MEM_FENCE | CLK_GLOBAL_MEM_FENCE);
        }
      __function_wide_invariant(__write_implies(u, (((((((((32) * (b0)) + (t0)) >= (0)) & ((((32) * (b0)) + (t0)) <= (1048575))) & ((n) >= (((((__write_offset_bytes(u)) / (sizeof(double))) / (n)) % ((n) - (1))) + (2)))) & (((((__write_offset_bytes(u)) / (sizeof(double))) / (n)) % ((n) - (1))) >= (1))) & ((n) >= ((((__write_offset_bytes(u)) / (sizeof(double))) % (n)) + (2)))) & ((((__write_offset_bytes(u)) / (sizeof(double))) % (n)) >= (1))) & ((((((32) * (b0)) + (t0)) - ((((__write_offset_bytes(u)) / (sizeof(double))) / (n)) % ((n) - (1)))) % (1048576)) == (0))));
      __function_wide_invariant(__read_implies(u, (((((((((32) * (b0)) + (t0)) >= (0)) & ((((32) * (b0)) + (t0)) <= (1048575))) & ((n) >= (((((__read_offset_bytes(u)) / (sizeof(double))) / (n)) % ((n) - (1))) + (2)))) & (((((__read_offset_bytes(u)) / (sizeof(double))) / (n)) % ((n) - (1))) >= (1))) & ((((__read_offset_bytes(u)) / (sizeof(double))) % (n)) >= (2))) & ((n) >= ((((__read_offset_bytes(u)) / (sizeof(double))) % (n)) + (1)))) & ((((((32) * (b0)) + (t0)) - ((((__read_offset_bytes(u)) / (sizeof(double))) / (n)) % ((n) - (1)))) % (1048576)) == (0))));
