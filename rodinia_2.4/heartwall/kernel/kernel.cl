...
{
  __requires(0 <= d_frame_no & d_frame_no < 20);
  ...
  __assume(d_common.in_sqr_elem == 2601);
  __assume(d_common.in_sqr_rows == 51);
  __assume(d_common.in_sqr_cols == 51);
  ...
  __assume(d_common.in2_sub_cumh_sel_elem == 17161);
  __assume(d_common.in2_sub_cumh_sel_rows == 131);
  __assume(d_common.in2_sub_cumh_sel_rowlow == 1);
  __assume(d_common.in2_sub_cumh_sel_collow == 52);
  __assume(d_common.in2_sub_cumh_sel2_rowlow == 1);
  __assume(d_common.in2_sub_cumh_sel2_collow == 1);

  __assume(d_common.in2_sub2_elem == 17161);
  __assume(d_common.in2_sub2_rows == 131);

  __assume(d_common.in2_sqr_elem == 6561);
  __assume(d_common.in2_sqr_rows == 81);
  __assume(d_common.in2_sqr_cols == 81);

  __assume(d_common.in2_sqr_sub2_elem == 17161);

  __assume(d_common.tMask_rows == 131);
  __assume(d_common.tMask_cols == 131);
  __assume(d_common.tMask_elem == 17161);

  __assume(d_common.mask_rows == 10);
  __assume(d_common.mask_cols == 10);
  __assume(d_common.mask_conv_rows == 131);
  __assume(d_common.mask_conv_cols == 131);
  __assume(d_common.mask_conv_elem == 17161);
	...
	if(d_frame_no != 0){
		...
		ei_new = tx;
		while(
              __global_invariant(__implies(bx < d_common.endoPoints, !__read(d_epiT))),
              __global_invariant(__implies(bx >= d_common.endoPoints, !__read(d_endoT))),
              __global_invariant(__read_implies(d_in, (__read_offset_bytes(d_in) - __ptr_offset_bytes(d_in))/sizeof(fp) < d_common.in_elem)),
              ei_new < d_common.in_elem){
		// while(ei_new < 1){
		...
		ei_new = tx;
		while(
              __global_invariant(__implies(__same_group & __write(d_unique_d_in2_sub_cumh), ((__write_offset_bytes(d_unique_d_in2_sub_cumh) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh))/sizeof(fp)%d_common.in2_sub_cumh_rows - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__implies(__same_group & __write(d_unique_d_in2_sub_cumh), ((__write_offset_bytes(d_unique_d_in2_sub_cumh) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh))/sizeof(fp)%d_common.in2_sub_cumh_rows - tx)/NUMBER_THREADS < d_common.in2_sub_cumh_rows)),
              __global_invariant(__implies(!__same_group & __write(d_unique_d_in2_sub_cumh), (__write_offset_bytes(d_unique_d_in2_sub_cumh) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh))/sizeof(fp) < d_common.in2_sub_cumh_elem)),
              __global_invariant(__implies(__same_group & __read(d_unique_d_in2_sub_cumh), ((__read_offset_bytes(d_unique_d_in2_sub_cumh) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh))/sizeof(fp)%d_common.in2_sub_cumh_rows - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__implies(__same_group & __read(d_unique_d_in2_sub_cumh), ((__read_offset_bytes(d_unique_d_in2_sub_cumh) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh))/sizeof(fp)%d_common.in2_sub_cumh_rows - tx)/NUMBER_THREADS < d_common.in2_sub_cumh_rows)),
              __global_invariant(__implies(!__same_group & __read(d_unique_d_in2_sub_cumh), (__read_offset_bytes(d_unique_d_in2_sub_cumh) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh))/sizeof(fp) < d_common.in2_sub_cumh_elem)),
              ei_new < d_common.in2_sub_cumh_rows){
			...
			// loop through all rows
			for(position = pos_ori;
                __invariant((position - pos_ori)%d_common.in2_sub_cumh_rows == 0),
                __global_invariant(__implies(__same_group & __write(d_unique_d_in2_sub_cumh), ((__write_offset_bytes(d_unique_d_in2_sub_cumh) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh))/sizeof(fp)%d_common.in2_sub_cumh_rows - tx)%NUMBER_THREADS == 0)),
                __global_invariant(__implies(__same_group & __write(d_unique_d_in2_sub_cumh), ((__write_offset_bytes(d_unique_d_in2_sub_cumh) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh))/sizeof(fp)%d_common.in2_sub_cumh_rows - tx)/NUMBER_THREADS < d_common.in2_sub_cumh_rows)),
                __global_invariant(__implies(!__same_group & __write(d_unique_d_in2_sub_cumh), (__write_offset_bytes(d_unique_d_in2_sub_cumh) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh))/sizeof(fp) < d_common.in2_sub_cumh_elem)),
                __global_invariant(__implies(__same_group & __read(d_unique_d_in2_sub_cumh), ((__read_offset_bytes(d_unique_d_in2_sub_cumh) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh))/sizeof(fp)%d_common.in2_sub_cumh_rows - tx)%NUMBER_THREADS == 0)),
                __global_invariant(__implies(__same_group & __read(d_unique_d_in2_sub_cumh), ((__read_offset_bytes(d_unique_d_in2_sub_cumh) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh))/sizeof(fp)%d_common.in2_sub_cumh_rows - tx)/NUMBER_THREADS < d_common.in2_sub_cumh_rows)),
                __global_invariant(__implies(!__same_group & __read(d_unique_d_in2_sub_cumh), (__read_offset_bytes(d_unique_d_in2_sub_cumh) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh))/sizeof(fp) < d_common.in2_sub_cumh_elem)),
                position < pos_ori+d_common.in2_sub_cumh_elem; position = position + d_common.in2_sub_cumh_rows){
		...
		ei_new = tx;
		while(
              __global_invariant(__implies(__same_group & __write(d_unique_d_in2_pad_cumv), ((__write_offset_bytes(d_unique_d_in2_pad_cumv) - __ptr_offset_bytes(d_unique_d_in2_pad_cumv))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
		...
		while(
              ...
              __global_invariant(__implies(__same_group & __write(d_unique_d_in2_pad_cumv), (__write_offset_bytes(d_unique_d_in2_pad_cumv) - __ptr_offset_bytes(d_unique_d_in2_pad_cumv))/sizeof(fp)/d_common.in2_pad_cumv_rows < d_common.in2_pad_cumv_cols)),
              __global_invariant(__implies(!__same_group & __write(d_unique_d_in2_pad_cumv), (__write_offset_bytes(d_unique_d_in2_pad_cumv) - __ptr_offset_bytes(d_unique_d_in2_pad_cumv))/sizeof(fp) < d_common.in2_pad_cumv_elem)),
              __global_invariant(__implies(__same_group & __read(d_unique_d_in2_pad_cumv), ((__read_offset_bytes(d_unique_d_in2_pad_cumv) - __ptr_offset_bytes(d_unique_d_in2_pad_cumv))/sizeof(fp)/d_common.in2_pad_cumv_rows - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__read_implies(d_unique_d_in2_pad_cumv, (__read_offset_bytes(d_unique_d_in2_pad_cumv) - __ptr_offset_bytes(d_unique_d_in2_pad_cumv))/sizeof(fp)/d_common.in2_pad_cumv_rows < d_common.in2_pad_cumv_cols)),
              ei_new < d_common.in2_pad_cumv_cols){
		...
		ei_new = tx;
		while(
              __global_invariant(__implies(__same_group & __write(d_unique_d_in2_sub_cumh), ((__write_offset_bytes(d_unique_d_in2_sub_cumh) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
		...
		while(
              __global_invariant(__implies(__same_group & __write(d_unique_d_in2_sub_cumh), ((__write_offset_bytes(d_unique_d_in2_sub_cumh) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__write_implies(d_unique_d_in2_sub_cumh, (__write_offset_bytes(d_unique_d_in2_sub_cumh) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh))/sizeof(fp) < d_common.in2_sub_cumh_elem)),
              __global_invariant(__implies(__same_group & __read(d_unique_d_in2_sub_cumh), ((__read_offset_bytes(d_unique_d_in2_sub_cumh) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
	...
	if(d_frame_no != 0 && (d_frame_no)%10 == 0){
		...
		while(
              ...
              __global_invariant(__implies(bx < d_common.endoPoints, !__read(d_epiT))),
              __global_invariant(__implies(bx >= d_common.endoPoints, !__read(d_endoT))),
              __global_invariant(__implies(__same_group & __read(d_in), ((__read_offset_bytes(d_in) - __ptr_offset_bytes(d_in))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__read_implies(d_in, (__read_offset_bytes(d_in) - __ptr_offset_bytes(d_in))/sizeof(fp) < d_common.in_elem)),
              ei_new < d_common.in_elem){
